...
import finalProjectDuplicate.Course;
...
public class Curriculum {
	...
	private static List<Course> course = new ArrayList<>(List.of(
			...
			// Prerequisite
			// Course (String category, String code, String[] prerequisite, int credits)
	...
	// Display Curriculum By Category method		
