...
public class TermSchedule {
	...
	public void printSchedule() {
		...
		for (Course c : schedule) {
			System.out.println( c.getCode() + "      |    " + c.getSection() + "    |  " + c.getTimeSlot() + "  |  " + c.getSeats() + "   | ");
		}
		System.out.println("--------------------------------------------------------------");
	}
	
	// Edit Seat Limit method
	...
	public void systemStatistics() {
	    ...
	    System.out.printf("Average Seats/Course : %.2f\n", averageSeats);
	    System.out.println("--------------------------------------");
	    ...
	    for (Course c : schedule) {
	        ...
	        // Count how many students registered this course
	        ...
	        System.out.println(c.getCode() + " |    " + c.getSection() + "    |  " + taken + "    |   " + c.getSeats() + "      |");
