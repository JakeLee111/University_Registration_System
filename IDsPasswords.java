...
public class IDsPasswords {
	...
	public static IDsPasswords getUser1() {
	    return user1;
	}

	public static IDsPasswords getUser2() {
	    return user2;
	}

	public static IDsPasswords getUser3() {
	    return user3;
	}

	public static IDsPasswords getUser4() {
	    return user4;
	}

	public static IDsPasswords getUser5() {
	    return user5;
	}

	public static IDsPasswords getUser6() {
	    return user6;
	}
